...
def get_feature_columns() -> list[str]:
    """
    Define the predictor columns used by the Gradient Boosting kWh model.
    """
    return [
        "hour_of_day",
        "day_of_week",
...
def plot_actual_vs_predicted(
    ...
    plt.title(f"Gradient Boosting (kWh): Actual vs Predicted ({dataset_name})")
    plt.xlabel("Time")
...
def plot_feature_importance(
    ...
    """
    Plot feature importance for the Gradient Boosting kWh model.
    """
    FIGURE_DIR.mkdir(parents=True, exist_ok=True)
    ...
    plt.title("Gradient Boosting Feature Importance for kWh Forecasting")
...
def main() -> None:
    """
    Train and evaluate the Gradient Boosting model for hourly total_kwh forecasting.
    """
    ...
    # Main Gradient Boosting tuning knobs
    n_estimators = 200
    learning_rate = 0.05
    max_depth = 3
    random_state = 42
    ...
    print(
        f"Using Gradient Boosting for kWh with n_estimators={n_estimators}, "
    ...
    plot_actual_vs_predicted(
        ...
        val_pred,
        "Validation",
        FIGURE_DIR / "gradient_boosting_kwh_val_actual_vs_pred.png",
        n_points=300,
    )
    ...
    plot_actual_vs_predicted(
        ...
        test_pred,
        "Test",
        FIGURE_DIR / "gradient_boosting_kwh_test_actual_vs_pred.png",
        n_points=300,
    )
    ...
    plot_feature_importance(
        model,
        feature_cols,
        FIGURE_DIR / "gradient_boosting_kwh_feature_importance.png",
    )
